...
INSERT INTO `8-orione` VALUES (1,'ABALLE','Dylan Sky, Cabarubias','CIVIL'),(2,'ALESNA','Paul Nicholas, Coliao','CIVIL'),(3,'ARPON','Josh Ethan, Watin','CIVIL'),(4,'BERSALES','Rett Jr., Tipait','CIVIL'),(5,'CABUENAS','Gemver, Quijano','CIVIL'),(6,'CALDOZA','Matthew Codee, Romanos','CIVIL'),(7,'CALLINO','Zel John, Longakit','CIVIL'),(8,'CAÃ‘ARES','Rigel Wyatt, Mendoza','CIVIL'),(9,'CANTILLAS','Marl Owen, Paloma','CIVIL'),(10,'CASIPONG','Jose Sean Rey, De Los Reyes','CIVIL'),(11,'CRUZ','Keiann Mykle, Batucan','CIVIL'),(12,'DIEZ','John Mark, Galano','CIVIL'),(13,'ENCISO','Zuriel James, Cabusas','CIVIL'),(14,'FELICES','Emmanuelle Wain Carlo, Lasquete','CIVIL'),(15,'GABUYA','Kyle Thomas Bryan, Osa','ELEX'),(16,'GANDIONCO','Jairuz Xavier, Velasco','ELEX'),(17,'GENON','Vinz Kyle, Flores','ELEX'),(18,'GONZALES','Dwayne Wade, Ancajas','ELEX'),(19,'GUY','Raeven Don, Borlasa','ELEX'),(20,'HANZAWA','Shinichiro Garneth, Momongan','ELEX'),(21,'HOFILEÃ‘A','Liam Gerard, Cavada','ELEX'),(22,'JACA','Mikhail Richthofen','ELEX'),(23,'JAVA','Jershom Dane, Ong','ELEX'),(24,'LAO','Iexak Ethanielle, King','ELEX'),(25,'MAARAT','NiÃ±o Miguel Sebastian, Ramos','ELEX'),(26,'MANGUBAT','Dom, Quirante','ELEX'),(27,'MENDOZA','Daver Fredson, Lisondra','ELEX'),(28,'NAZARENO','Ian Greg Felix, Pongase','ELEX'),(29,'OBESO','Renzo Joshua','MECH'),(30,'ONG V AÃ‘O','Andre, Tampos','MECH'),(31,'PANERIO','Denz Clark, Blanco','MECH'),(32,'PARAS','Raphael Bransan, Gabas','MECH'),(33,'QUILO','Manuel Gabriel, Del Corro','MECH'),(34,'REYES','Josef Vince Dominic, Ovilla','MECH'),(35,'SARIO','Alaine Gabriel, Dorimon','MECH'),(36,'SIMOGAN','M Manuel Angel, Ceniza','MECH'),(37,'SUMABON','Eugene Carlo','MECH'),(38,'TAN','Orren Edcen, Tia','MECH'),(39,'TAN','Zhacaree Chino, Navarro','MECH'),(40,'TEVES','NiÃ±o Sebastian, Manug','MECH'),(41,'VILLANUEVA','Khail Manu, Calderon','MECH'),(42,'YBAÃ‘EZ','Azriel James, Daigo','MECH');
...
INSERT INTO `9-kowalski` VALUES ('id','lastname','firstname','elective');
...
INSERT INTO `9-versiglia` VALUES (1,'ACEBEDO','Gaeb Gil Ray, Oronce','ELEX'),(2,'AMAHAN','Anthony Seth, Hayag','ELEX'),(3,'ANG','Glyn Jefferson, Batuigas','ELEX'),(4,'ANTONE','Jahdrienne Joe, Inocian','ELEX'),(5,'BACULA','Tristan John, CeÃ±al','ELEX'),(6,'BELANDRES','Shen Lance, Cortes','ELEX'),(7,'CABRIDO','Chasler Keith, Araneta','ELEX'),(8,'COROMINAS','Juan Miguel, Apostol','ELEX'),(9,'CULANGO','Jessierylle, Al','ELEX'),(10,'DELA VICTORIA','Marco Vicente, Dango','ELEX'),(11,'DURANO','Ethan Zeke, Castrudes','MECH'),(12,'ECHAVIA','Charles Andrae, Auman','ELEX'),(13,'EMIA','Cezar Agustus, Toledo','ELEX'),(14,'GANTUANGCO','Zaian Aiden, Balasa','MECH'),(15,'GO','John Jacob, Reyes','MECH'),(16,'GUISADIO','Dean Matthew, Abellanosa','MECH'),(17,'IPONG','Jon Andre, Policarpio','MECH'),(18,'LABIDES','Rynelzhen Dylan','MECH'),(19,'LARGO','Axel Carlo, Oberes','MECH'),(20,'LUCAS','Gene Marione, Coronado','MECH'),(21,'MANLIGUEZ','Rajah Dariel, Gonzales','MECH'),(22,'MANORIÃ‘A','Mikhael Francis, Palanas','MECH'),(23,'MANTILLA','Chino, Minaya','MECH'),(24,'NAIGAL','Christian, Marte','CIVIL'),(25,'NARBOADA','Ghian Alexis, Siboa','MECH'),(26,'PABLEO','Ranver, Vertudazo','MECH'),(27,'PALLER','Sylvester, Buagas','CIVIL'),(28,'RABONG','James Zachary, Federico','CIVIL'),(29,'RAMA','John Jr., EdaÃ±o','CIVIL'),(30,'RAMIREZ','Nathan Hayden','CIVIL'),(31,'REGALADO','Tristan Jake, Cagalawan','CIVIL'),(32,'SARAÃ‘A','Carl Vince Laurence, Ynclino','CIVIL'),(33,'SOLLANO','Qyel Ino, Villanueva','CIVIL'),(34,'SUMANTING','Franz Mikel NiÃ±o, Gerasmio','CIVIL'),(35,'VELASCO','Mj, Sillacay','CIVIL'),(36,'YAPCHING','Gol Martin, Kintanar','CIVIL');
...
-- Dump completed on 2023-12-04 23:57:55
